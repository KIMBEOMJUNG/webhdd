        ...
        *********************************************************************************************************************************************************** -->
		...
		<section id="main-content">
			<section class="wrapper">
				<h3>
					<i class="fa fa-angle-right"></i>가입하기
				</h3>
				</div>
				</div>
				</div>
								...
								<form class="cmxform form-horizontal style-form" id="signupForm"
									...
									<div class="form-group ">
										...
										<div class="col-lg-10">
											...
											<input class="btn btn-theme" style="margin-top: 12px;" id="bubu" type="button"
									...
									<div class="form-group">
										<div class="col-lg-offset-2 col-lg-10">
											...
											<button class="btn btn-theme04" type="button"
												onclick="location.href='../bj/main.do'">취소</button>
										</div>
									</div>
								</form>
							</div>
...
>>>>>>> bda3cb9620e907df1c07c05858e244f9f9b25c86
